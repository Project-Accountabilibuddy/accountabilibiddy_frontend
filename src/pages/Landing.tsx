  ...
  return (
    <StyledLanding>
      ...
      <h3 className="body-2">
        ...
        designed that way to ensure you are serious about your chosen Project,
        as it will take real effort and time. If you choose to utilize this tool
        realize that you are taking a huge first step, though I don’t believe
